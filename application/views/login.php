                    ...
                    <div class="card-body p-0">
                        <div class="p-5">
                            <div class="text-center py-3">
                                <img src="<?php echo base_url() ?>assets/img/seal.jpg" class="w-50 px-1 rounded-square mb-3">
                                <h1 class="h2 text-gray-900">Solid Waste Collection Management System</h1>
